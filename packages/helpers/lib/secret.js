(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('the-answer'), require('react-redux'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'the-answer', 'react-redux'], factory)
    : ((global = global || self),
      factory((global.mysecret = {}), global['yj-answer'], global.reactRedux));
})(this, function(exports, answer, reactRedux) {
  'use strict';

  answer =
    answer && answer.hasOwnProperty('default') ? answer['default'] : answer;
  ...
  function myanswer(str) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, axios$1.get('http://www.baidu.com')];
          case 1:
            result = _a.sent();
            console.log(
              'the answer is ' + answer + find('hello world', 'world')
            );
            console.log('version:', version);
            console.log('connect:', reactRedux.connect, result);
            return [2 /*return*/];
        }
      });
    });
